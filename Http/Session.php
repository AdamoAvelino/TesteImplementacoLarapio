...
class Session
{
     ...
     */
    public function __construct($iniciar = false, $name = "LARIBOLO")
    {
        if ($iniciar) {
            session_name($name);
            session_start();
     ...
     * @return void
     */
    public function setFlash($tipo, $chave, $valor)
    {
        $_SESSION['flash'][$tipo][$chave] = $valor;
     ...
     * @return void
     */
    public function deletaSession($chave)
    {
